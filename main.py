...
image_folder = r"C:\Users\mrcha\OneDrive\Desktop\REAL TIME  DETECTION AND ALERTS USING AI AND CAMERA MODULE\screenshots"
...
# Load known faces
try:
    charukesh_image = face_recognition.load_image_file(r"C:\Users\mrcha\OneDrive\Desktop\REAL TIME  DETECTION AND ALERTS USING AI AND CAMERA MODULE\photos\1.jpg")
    charukesh_encoding = face_recognition.face_encodings(charukesh_image)[0]
    
    karthi_image = face_recognition.load_image_file(r"C:\Users\mrcha\OneDrive\Desktop\REAL TIME  DETECTION AND ALERTS USING AI AND CAMERA MODULE\photos\2.jpg")
    karthi_encoding = face_recognition.face_encodings(karthi_image)[0]

    sriraam_image = face_recognition.load_image_file(r"C:\Users\mrcha\OneDrive\Desktop\REAL TIME  DETECTION AND ALERTS USING AI AND CAMERA MODULE\photos\3.jpg")
    sriraam_encoding = face_recognition.face_encodings(sriraam_image)[0]

    kishore_image = face_recognition.load_image_file(r"C:\Users\mrcha\OneDrive\Desktop\REAL TIME  DETECTION AND ALERTS USING AI AND CAMERA MODULE\photos\4.jpg")
